...
For model evaluation, we split dataset in 80:20 ratio (train-test split) maintaining the class proportions. The learning curve results are shown below (and in Figure 1). And respective F1-scores are mentioned in Appendix-1
```{r, echo=FALSE}
library(pander)
library(ggplot2)
