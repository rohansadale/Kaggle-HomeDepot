...
base_dir = '/Users/akshaykulkarni/Documents/study/ML/course/project/data/'
...
features_df = pd.DataFrame(featureExtraction.features,
			...
			'attribute_matched', 'bullet_count', 'has_height', 'has_depth', 'has_length', 'has_width', 'is_relevant'])
