...
features_df = pd.DataFrame(featureExtraction.features,
			columns = ['jaccard_unigram_title', 
			'jaccard_unigram_desc',
			'jaccard_bigram_title', 'jaccard_bigram_desc',
			'edit_distance_title', 
			'edit_distance_desc', 
			'first_intersect_count_unigram', 'last_intersect_count_unigram',
			'first_intersect_count_bigram', 'last_intersect_count_bigram',
			'intersect_count', 
			'mean_intersect_position',
			'avg_similarity','rmse_title', 
			'rmse_desc', 
			'longest_match', 
			'attribute_matched', 
			'coccurence_count', 
